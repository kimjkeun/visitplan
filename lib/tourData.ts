  ...
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        placeInfo: {
          description: '궁원안과(宮原眼科)는 1927년 일제강점기에 일본인 안과의사 미야하라 타카오가 개업한 안과병원으로, 당시 타이중에서 가장 크고 현대적인 안과였습니다. 하지만 세월이 흘러 폐허가 되어 버려졌던 이 건물을 2010년 대만의 유명 제과업체 "일출(日出)"가 인수하여 5년에 걸쳐 복원했습니다. 복고풍 유럽 스타일의 웅장한 내부는 마치 해리포터의 호그와트 도서관을 연상시키며, 천장까지 닿는 높은 서가에는 책과 펑리수(파인애플 케이크) 상자들이 예술작품처럼 진열되어 있습니다. 1층은 펑리수 전문점으로 대만 최고의 펑리수를 판매하며, 2층은 고급 레스토랑으로 운영됩니다. 특히 유명한 것은 아이스크림으로, 타이중을 대표하는 디저트로 자리잡았습니다. 다양한 토핑과 함께 제공되는 화려한 비주얼은 SNS에서 큰 인기를 끌고 있습니다. 단순한 쇼핑 공간을 넘어 타이중의 역사와 현대가 조화롭게 공존하는 문화 공간으로, 방문객들에게 시각적 즐거움과 미각적 만족을 동시에 선사하는 곳입니다.',
          highlights: [
